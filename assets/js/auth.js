// Auth handlers (email + Google) with redirect fallback and robust click handling
...
async function doLogin(){
  ...
  try{ await auth.signInWithEmailAndPassword(email, pass); document.getElementById("login-modal").close(); }
...
// Google sign-in (delegation + popup->redirect fallback)
document.addEventListener("click", (e)=>{
