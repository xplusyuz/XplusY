...
export async function loadCSV(url){ const res=await fetch(url,{cache:'no-store'}); if(!res.ok) throw new Error('CSV yuklab bo‘lmadi: '+url); return parseCSV(await res.text()); }
