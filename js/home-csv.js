...
// CSV → Grid (cards only). Columns: Img url | Title | Meta | tugma nomi | tugma linki
...
function renderFallback(){
  grid.innerHTML = `<div class="card"><h2>Misol karta</h2><p class="sub">home.csv faylini to‘ldiring.</p></div>`;
}
