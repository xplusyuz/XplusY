...
function ensureBottomBar(){
  ...
  bar.innerHTML = `
    <a href="/index.html" data-path="/index.html" aria-label="Bosh"><span>🏠</span><i>Bosh</i></a>
    <a href="/tests.html" data-path="/tests.html" aria-label="Testlar"><span>📝</span><i>Testlar</i></a>
    <a href="/live.html" data-path="/live.html" class="big" aria-label="Live"><span>🎮</span><i>Live</i></a>
    <a href="/leaderboard.html" data-path="/leaderboard.html" aria-label="Reyting"><span>🏅</span><i>Reyting</i></a>
    <a href="/settings.html" data-path="/settings.html" aria-label="Sozlamalar"><span>⚙️</span><i>Sozlamalar</i></a>`;
  document.body.appendChild(bar);
  // active tab
  const p = location.pathname.replace(/\/index\.html$/, '/index.html');
  document.querySelectorAll('#bottomBar a').forEach(a=>{
    const pp = a.getAttribute('data-path');
    if(p.endsWith(pp)) a.classList.add('active');
  });
}
export async function initUXChrome(){
  // Theme only
