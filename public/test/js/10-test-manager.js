        ...
        const testManager = {
            ...
            _katexSafeHtml(html) {
                try {
                    ...
                    // If utils has normalizeMathDelimiters use it, else keep as-is
                    if (window.utils && typeof utils.normalizeMathDelimiters === 'function') {
                        return utils.normalizeMathDelimiters(t);
                    }
                    return t;
            ...
            _renderMath(root) {
                try {
                    if (window.utils && typeof utils.renderMath === 'function') {
                        utils.renderMath(root);
                    } else if (window.__LM_KATEX_RENDER) {
                        window.__LM_KATEX_RENDER(root || document.body);
                    }
                } catch (e) {}
            },
updateHeaderOffset() {
            ...
            renderQuestion() {
                ...
                dom.elements.questionText.innerHTML = this._katexSafeHtml(randomQuestion.text || '');
                this._renderMath(questionText);
            ...
            loadQuestionImage(randomQuestion, originalIndex) {
                ...
                // KaTeX render everything in the question card
                this._renderMath(dom.elements.questionCard || dom.elements.questionText);
