                ...
                if (ps) {
                    ...
                    if (saveStatus?.ok) {
                        ...
                        if (saveStatus.mode === 'open') {
                            ...
                            // TestCode natijasi
                            html += saveStatus.savedToTestCode
                                ? `<small>✅ Natija test_code bo‘yicha saqlandi.</small>`
                                : `<small>⚠️ Natijani saqlashda muammo (API /results/submit). Netlify function va env tekshiring.</small>`;
